...
`--event-handlers mission_control+`, for every build with
`COLCON_MISSION_CONTROL=1`, or through `~/.colcon/defaults.yaml`. The
...
class MissionControlEventHandler(EventHandlerExtensionPoint):
    ...
    def __init__(self):  # noqa: D107
        ...
        self.enabled = os.environ.get(
            "COLCON_MISSION_CONTROL", "").lower() in ("1", "yes", "true", "on")
        self._done = False
